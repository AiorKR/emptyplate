...
function fn_view(shopUID) {
	event.stopPropagation(); //이벤트 버블링과 캡처링 방지
            ...
            <c:if test="${!empty list}">
                  <c:forEach items="${list}" var="shop" varStatus="status">
                        ...
                        <span style="position: relative; bottom:200px; left: 600px;">    
                            ...
                            <p class="fa-solid fa-pen" style="color:#cda45e;">
                                ${shop.shopIntro}
                            </p>
                            <p class="int">           
                             <c:forTokens items="${shop.shopHashtag}" delims = "#" var="shopHashtag">
                           			<span onclick="fn_search('${shopHashtag}')" style="cursor: pointer;" class="shopHashtag">
                           ...
                           <c:forEach items="${list}" var="shop" varStatus="status">
                                <tr onclick="fn_view('${shop.shopUID}')" style="cursor:pointer;">
                                  ...
                                  <h2>
                                     ...
                                     <c:forTokens items="${shop.shopHashtag}" delims = "#" var="shopHashtag">
                                          <span>
                                          		<i class="fa-solid fa-hashtag"  onclick="fn_search('${shopHashtag}')" style="font-size:25px;cursor:pointer;">
                                          				<c:out value='${shopHashtag}'/>
                                          		</i>
                                          </span>
                                     </c:forTokens>
                                     <br /><br />
                                     <i class="fa-solid fa-map-location-dot" style="font-size:25px;">
                                     	<c:out value="${shop.shopLocation1}" />
                                     	<c:out value="${shop.shopLocation2}" />
                                     	<c:out value="${shop.shopLocation3}" />
                                     </i>
                                     <br /><br />
                                     <i class="fa-solid fa-pen" style="color:#cda45e; font-size:25px;">
