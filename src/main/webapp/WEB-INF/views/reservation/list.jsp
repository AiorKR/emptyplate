                  ...
                  <c:if test="${!empty list}">
                        <c:forEach items="${list}" var="shop" varStatus="status">
                           <div class="swiper-slide" style="height: auto; width: 100%; background-color: rgba(240, 240, 240, 0.7);">
                              <div class="reservation-item" style="height:350px;" onclick="fn_view('${shop.shopUID}')" style="cursor:pointer;">
                                     <img alt="" src="../resources/upload/shop/${shop.shopUID}/${shop.shopFile.shopFileName}" style="height: 300px;width:300px; position: relative; left: 150px; top:25px;">
                                    ...
                                    <c:forEach items="${list}" var="shop" varStatus="status">
                                      <tr onclick="fn_view('${shop.shopUID}')" style="cursor:pointer;">
                                              <td class="w-25" colspan="4">
                                                 <img src='../resources/upload/shop/${shop.shopUID}/${shop.shopFile.shopFileName}' class="img-fluid img-thumbnail" style="height: 200px;width: 200px; " >
                                              </td>
                                              <td>
