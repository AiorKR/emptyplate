...
<body>
	<form>
		...
		<input type="text" id="userPwd" name="userPwd" class="pwds" placeholder="변경하실 비밀번호를 입력해주세요." maxlength="12">
		<input type="text" id="userPwd2" name="userPwd2" class="pwds" placeholder="다시 한번 입력해주세요." maxlength="12">
